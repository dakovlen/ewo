...
// Query: *[    _type in ["page", "post", "author", "category"] &&    defined(slug.current) &&    !(_id in path("drafts.**"))  ] {    "href": select(      _type == "page" => "/" + slug.current,      _type == "post" && defined(publishedAt)   => "/blog/" + slug.current,      _type == "author" => "/authors/" + slug.current,      _type == "category" => "/category/" + slug.current    ),    _updatedAt  }[defined(href)]
